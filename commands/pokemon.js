...
module.exports= {
    ...
    async execute(message,client,text){
       ...
       if(!data){message.reply("that is not a pokemon see if you misspelled it"); return;}
       console.log(data)
            e();
            async function e(){
            ...
            }else{message.reply("that is not a pokemon see if you misspelled it"); return;}
